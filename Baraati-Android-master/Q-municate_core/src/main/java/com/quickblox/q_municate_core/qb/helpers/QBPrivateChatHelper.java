...
public class QBPrivateChatHelper extends QBBaseChatHelper {
    ...
    public void sendPrivateMessageWithAttachImage(QBFile file, int userId) throws QBResponseException {
        if(file.getContentType().contains("image")) {
            sendPrivateMessage(file, context.getString(R.string.dlg_picture_last_message), userId);
        }else{
            sendPrivateMessage(file, context.getString(R.string.dlg_video_last_message), userId);
        }
    ...
    public void sendPrivateMessage (JSONObject jsonObject, int userId) throws QBResponseException {

        QBChatMessage qbChatMessage = getQBChatMessage(jsonObject.toString(), null);
