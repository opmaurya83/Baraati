...
public class QBGroupChatHelper extends QBBaseChatHelper {
    ...
    public void sendGroupMessage(String roomJidId, JSONObject message) throws Exception {
        QBChatMessage chatMessage = getQBChatMessage(message.toString(), null);
        sendGroupMessage(chatMessage, roomJidId, currentDialog.getDialogId());
    }
    ...
    public void sendGroupMessageWithAttachImage(String roomJidId, QBFile file) throws QBResponseException {
        ...
        if(file.getContentType().contains("image")) {
            chatMessage = getQBChatMessage(context.getString(R.string.dlg_picture_last_message),file);
        }else{
            chatMessage = getQBChatMessage(context.getString(R.string.dlg_video_last_message),file);
        }
