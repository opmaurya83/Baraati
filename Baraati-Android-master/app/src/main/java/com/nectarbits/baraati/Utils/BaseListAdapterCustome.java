...
public abstract class BaseListAdapterCustome<T> extends BaseAdapter {

    protected LayoutInflater inflater;
    protected Context context;
    protected List<T> objectsList;

    public BaseListAdapterCustome(Context context) {
        this(context, new ArrayList<T>());
    }

    public BaseListAdapterCustome(Context context, List<T> objectsList) {
