...
public class DashboardAdapter extends RecyclerView.Adapter<DashboardAdapter.MyHolder> {
    ...
    private List<SubCategory> mArrayList;
    private OnUserCheckListSelect onUserCheckListSelect;
    DashboardEventTypeAdapter dashboardEventTypeAdapter;

    public DashboardAdapter(Context context, List<SubCategory> arrayList, OnUserCheckListSelect onSubCategorySelect){
        mContext = context;
    ...
    public void onBindViewHolder(MyHolder holder, final int position) {
      ...
      holder.txtSubcategory.setText(mArrayList.get(position).getSubcategory());
        dashboardEventTypeAdapter=new DashboardEventTypeAdapter(mContext,mArrayList.get(position).getEvents(),onUserCheckListSelect);
