...
public class ProductListAdapter extends RecyclerView.Adapter<ProductListAdapter.MyHolder> {
    ...
    public ProductListAdapter(Context context, List<ProductDetail> arrayVendorLists , OnProductSelect onProductSelect){
        mContext = context;
    ...
    @Override
    public void onBindViewHolder(ProductListAdapter.MyHolder holder, int position) {
        ...
        holder.txtPrice.setText(mContext.getString(R.string.rs)+ GH.getFormatedAmount(productDetailList.get(position).getPrice()));
