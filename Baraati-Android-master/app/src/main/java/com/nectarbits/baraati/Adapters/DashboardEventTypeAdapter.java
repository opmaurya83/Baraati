...
import com.nectarbits.baraati.VendorListActivity;
 ...
 */
public class DashboardEventTypeAdapter extends ExpandableRecyclerAdapter<DashboardEventTypeAdapter.ParentViewHolder_P,DashboardEventTypeAdapter.ChildViewHolder_C> {

    private Context mContext;
    private List<Event> mArrayList;
    private OnUserCheckListSelect onUserCheckListSelect;
    private LayoutInflater mInflator;
    public DashboardEventTypeAdapter(Context context, @NonNull List<? extends ParentListItem> arrayList, OnUserCheckListSelect onUserCheckListSelect){
        super(arrayList);
        mContext = context;
    ...
    public class ChildViewHolder_C extends com.bignerdranch.expandablerecyclerview.ViewHolder.ChildViewHolder {
       ...
       /*     if(eventType.getSelect()){
            ...
            if(eventType.getShared().equalsIgnoreCase("1")){
                tblRow.setBackgroundResource(R.color.color_shared_event);
            }else{
                tblRow.setBackgroundResource(R.color.white);
            }
