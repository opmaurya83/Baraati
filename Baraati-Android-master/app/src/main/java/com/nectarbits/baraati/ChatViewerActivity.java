...
import com.nectarbits.baraati.Fragment.ChatImageViewerFragment;
import com.nectarbits.baraati.Fragment.ProductImageViewerFragment;
...
public class ChatViewerActivity extends AppCompatActivity {
   ...
   /* @Bind(R.id.llImageCapsule)
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       imageArrayList = GeneralSingletone.getInstance().getChatImageList();
  ...
  /*  private void implementToolbar() {
    ...
    private void createNewFragment(List<String> mArrayList) {
        fragmentsArray = new ArrayList<Fragment>();
        for (int i = 0; i < mArrayList.size(); i++) {
            ChatImageViewerFragment fragment = new ChatImageViewerFragment(mContext, mArrayList, "" + i);
