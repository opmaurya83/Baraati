...
public class BadgeDrawable extends Drawable {
    ...
    public BadgeDrawable(Context context) {
        float mTextSize = context.getResources().getDimension(R.dimen.small_Fonts);

        mBadgePaint = new Paint();
        mBadgePaint.setColor(ContextCompat.getColor(context,R.color.colorWhite));
        ...
        mTextPaint.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.colorPrimary));
