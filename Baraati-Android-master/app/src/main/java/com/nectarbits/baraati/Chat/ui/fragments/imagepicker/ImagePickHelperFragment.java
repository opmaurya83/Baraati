...
import com.nectarbits.baraati.Chat.tasks.GetFilepathFromUriTask;
...
public class ImagePickHelperFragment extends Fragment {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (isResultFromImagePick(requestCode, resultCode, data)) {
            ...
            }else if(requestCode == ImageUtils.CAMERA_VIDEO_REQUEST_CODE && (data == null || data.getData() == null)){
                data = new Intent();
                data.setData(Uri.fromFile(ImageUtils.getLastUsedCameraFile()));
            }
    ...
    private boolean isResultFromImagePick(int requestCode, int resultCode, Intent data) {
        return resultCode == Activity.RESULT_OK && ((requestCode == ImageUtils.CAMERA_REQUEST_CODE)|| (requestCode == ImageUtils.CAMERA_VIDEO_REQUEST_CODE) || (requestCode == ImageUtils.GALLERY_REQUEST_CODE && data != null));
    }
}