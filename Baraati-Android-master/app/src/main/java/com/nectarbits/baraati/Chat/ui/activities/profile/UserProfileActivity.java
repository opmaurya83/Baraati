...
import com.nectarbits.baraati.ChatViewerActivity;
import com.nectarbits.baraati.ProductImageViewerActivity;
    ...
    private void initFields() {
        ...
        avatarImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                stringList.add(user.getAvatar());
                GeneralSingletone.getInstance().setChatImageList(stringList);
                Intent intent=new Intent(UserProfileActivity.this,ChatViewerActivity.class);
                intent.putExtra(AppUtils.ARG_MORE_POSITION,0);
