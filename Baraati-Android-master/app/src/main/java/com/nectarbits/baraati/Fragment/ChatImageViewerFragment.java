...
public class ChatImageViewerFragment extends Fragment {
    private Context mContext;
    private List<String> mArrayList;
    private String mPosition;
    PhotoViewAttacher mAttacher;
    public ChatImageViewerFragment(Context context, List<String> arrayList, String position){
        mContext=context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mArrayList.get(Integer.parseInt(mPosition)) != null){
            Picasso.with(mContext)
                    .load(mArrayList.get(Integer.parseInt(mPosition)) )
