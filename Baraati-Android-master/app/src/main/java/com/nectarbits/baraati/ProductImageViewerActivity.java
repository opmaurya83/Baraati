 ...
 */
public class ProductImageViewerActivity extends AppCompatActivity {
   ...
   /* @Bind(R.id.llImageCapsule)
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       imageArrayList = GeneralSingletone.getInstance().getMoreimageList_product();
  ...
  /*  private void implementToolbar() {
    ...
    private void createNewFragment(List<Moreimage> mArrayList) {
        ...
        for (int i = 0; i < mArrayList.size(); i++) {
            ProductImageViewerFragment fragment = new ProductImageViewerFragment(mContext, mArrayList, "" + i);
