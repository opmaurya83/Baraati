...
import com.nectarbits.baraati.Chat.tasks.QBGCMRegistrationTask;
...
public class GSMHelper {
    ...
    public void registerInBackground() {
       QBGCMRegistrationTask qbgcmRegistrationTask=new QBGCMRegistrationTask(activity);
        qbgcmRegistrationTask.execute(googleCloudMessaging);
    }
