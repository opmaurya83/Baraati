...
import com.nectarbits.baraati.Chat.ui.adapters.chats.GroupDialogOccupantsAdapter;
...
public class GroupDialogDetailsActivity extends BaseLoggableActivity implements AdapterView.OnItemClickListener, OnImagePickedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        groupNameEditText.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
