 ...
 */
public class ResponsibilityListAdapter_1 extends RecyclerSwipeAdapter<ResponsibilityListAdapter_1.MyHolder> {

    private Context mContext;
    private List<SharedeventDetail> mArrayList;

    private  OnMemberClick onMemberClick;
    public ResponsibilityListAdapter_1(Context context, List<SharedeventDetail> arrayList, OnMemberClick onSubCategorySelect){
        mContext = context;
...
/*    @Override
    ...
    @Override
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_responsible_member_1,parent,true);
    ...
    public void onBindViewHolder(MyHolder viewHolder, int position) {
        ...
        /*    ColorStateList csl = AppCompatResources.getColorStateList(mContext, R.color.orange);
            ...
            DrawableCompat.setTintList(drawable, csl);
            holder.iv_status.setImageDrawable(drawable);*/
            holder.tvt_member.setText(mContext.getString(R.string.str_sent));
            holder.tvt_member.setTextColor(ContextCompat.getColor(mContext,R.color.orange));
        }else if(mArrayList.get(position).getInvitationStatus().equalsIgnoreCase(AppUtils.Accepted)){
            //older.iv_status.setImageResource(R.drawable.icon_share_green);
         /*   ColorStateList csl = AppCompatResources.getColorStateList(mContext, R.color.green);
            Drawable drawable = DrawableCompat.wrap( holder.iv_status.getDrawable());
            ...
            holder.tvt_member.setText(mContext.getString(R.string.accepted));
            holder.tvt_member.setTextColor(ContextCompat.getColor(mContext,R.color.green));
          ...
          /*  ColorStateList csl = AppCompatResources.getColorStateList(mContext, R.color.red);
            ...
            holder.tvt_member.setText(mContext.getString(R.string.reject));
            holder.tvt_member.setTextColor(ContextCompat.getColor(mContext,R.color.red));
        }
